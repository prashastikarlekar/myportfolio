		...
		<Section classProp={`${hero.section}`}>
			<Container spacing={"VerticalXXXL"}>
				...
				<section>
					...
					<h1 className={`${hero.usp} ${hero.primaryDim}`}>
						{content.header.usp}
					</h1>
				</section>
				<section>
					<p
						className={`${hero.primaryBright} ${hero.para} subtitle ${space([
							"verticalLrg",
						])}`}>
						{content.paragraph}
					</p>
				...
				<section>
					<button
						...
						onClick={() =>
							(window.location = "mailto:prashastikarlekar@gmail.com")
						}>
					...
					<button
						...
						onClick={() =>
							window.open(
								"https://www.linkedin.com/in/prashasti-karlekar/",
								"_blank"
							)
						}>
					...
					<button
						className={`button ${button.secondary} leaveSite`}
						onClick={() =>
							window.open("https://github.com/prashastikarlekar", "_blank")
						}>
						{content.buttons.ternary.title}
					</button>
					<button
						className={`button ${button.secondary} leaveSite`}
						onClick={() =>
							window.open(
								"https://drive.google.com/file/d/1AoPCnNY7HrDR7EA_SafFw58ilEoGWRlE/view?usp=sharing",
								"_blank"
							)
						}>
